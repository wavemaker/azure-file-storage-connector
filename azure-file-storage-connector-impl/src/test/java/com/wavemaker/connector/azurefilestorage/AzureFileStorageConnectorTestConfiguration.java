...
@Configuration
@ComponentScan(basePackages = "com.wavemaker.connector.azurefilestorage")
public class AzureFileStorageConnectorTestConfiguration extends ConnectorConfigurationBase {
